...
<body>
    <nav class="navbar navbar-expand-sm navbar-light mb-1">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="https://drive.google.com/file/d/1g7y1w5iYgVlAOKOppyPLn-EawEYgo/view?usp=sharing">Resume</a>
            </li>
        </ul>
    </nav>
        ...
        <section class="landing">
            <div class="row vertical-center">
                <div class="col-lg-8 text-left pb-5">
                    <h1 class="display-3">Archit Sharma</h1>
                    <p class="lead pl-2">
                ...
                <div class="col-lg-6 wrap text-left">
                    <div class="about-desc">
                        ...
                        <div class="pt-5">
                            ...
                            <p>My name is Archit. I’m a junior from 🇮🇳 I'm an open-source enthusiast, a learner & an educator📕I'm deeply passionate about software development & innovations. 
                                I believe in the power of community & have also given talks at various conferences 🎙
                            </p>

                            <ul class="social-links list-unstyled mt-4">
                                <li><a href="mailto:archit8679@gmail.com">
                                        <ion-icon name="mail-outline"></ion-icon>
                                    </a></li>
                                <li><a href="https://github.com/iarchitsharma">
                                        <ion-icon name="logo-github"></ion-icon>
                                    </a></li>
                                <li><a href="https://www.linkedin.com/in/iarchitsharma/">
                                        <ion-icon name="logo-linkedin"></ion-icon>
                                    </a></li>
                                
                                <li><a href="https://twitter.com/iarchitsharma">
                                        <ion-icon name="logo-twitter"></ion-icon>
                                    </a></li>
                                <li><a href="https://www.instagram.com/iarchitsharma/">
                                    <ion-icon name="logo-instagram"></ion-icon>
                                    </a></li>
                                
                                <li><a href="https://www.youtube.com/channel/UCfv8cdsGg">
            ...
            <h1 class="bold-text bg-text">Contact</h1>
                    <div class="text-left">
                            <div class="pt-5">
                                ...
                                <ul class="social-links list-unstyled mt-4">
                                    <li><a href="mailto:kunalkushwaha453@gmail.com">
                                        <ion-icon name="mail-outline"></ion-icon>
                                    </a></li>
